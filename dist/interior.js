...
const base=validate(baseRaw),expanded=validate(expandedRaw);let original=false,view='plan';const layers={entry:true,kitchen:false,furniture:false};const viewer=createShared3D($('#scene'));let editor;
